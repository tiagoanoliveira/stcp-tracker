...
class StopView {
  ...
  displayArrivals(arrivals, vehicles) {
    ...
    if (!arrivals || arrivals.length === 0) {
      container.innerHTML = '<p class="no-arrivals">⚠️ Foram registadas anomalias na informação prestada sobre as próximas chegadas em tempo real pela STCP.<br><br> Consulte <a href="busmap.html"> aqui a localização em tempo real dos autocarros</a> ou verifique o horário planeado na paragem.</p>';
      return;
    }
