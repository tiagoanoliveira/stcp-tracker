...
const STCP_ROUTES = [
  ...
  { id: '201',  number: '201', name: 'Campo Alegre - Nau Vitória',             color: '#187EC2', text_color: '#FFFFFF' },
  { id: '202',  number: '202', name: 'Cordoaria - Matosinhos',                 color: '#187EC2', text_color: '#FFFFFF' },
  { id: '203',  number: '203', name: 'Matosinhos - Custóias',                  color: '#187EC2', text_color: '#FFFFFF' },
  { id: '204',  number: '204', name: 'Praça Parada Leitão - Leça da Palmeira', color: '#187EC2', text_color: '#FFFFFF' },
  { id: '205',  number: '205', name: 'Marquês - Boa Nova',                     color: '#187EC2', text_color: '#FFFFFF' },
  { id: '206',  number: '206', name: 'Praça Parada Leitão - Moselos',          color: '#187EC2', text_color: '#FFFFFF' },
  { id: '207',  number: '207', name: 'Marquês - Maia (Câmara Municipal)',      color: '#187EC2', text_color: '#FFFFFF' },
  { id: '208',  number: '208', name: 'Cordoaria - Maia (Câmara Municipal)',    color: '#187EC2', text_color: '#FFFFFF' },
  { id: '209',  number: '209', name: 'Campo Alegre - Maia (Hospital)',         color: '#187EC2', text_color: '#FFFFFF' },
  { id: '301',  number: '301', name: 'Aliados - Gondomar (S. Cosme)',          color: '#187EC2', text_color: '#FFFFFF' },
  { id: '302',  number: '302', name: 'Aliados - Valbom',                       color: '#187EC2', text_color: '#FFFFFF' },
  { id: '303',  number: '303', name: 'Cordoaria - Venda Nova',                 color: '#187EC2', text_color: '#FFFFFF' },
  { id: '304',  number: '304', name: 'Aliados - Fânzeres',                     color: '#187EC2', text_color: '#FFFFFF' },
  { id: '305',  number: '305', name: 'Aliados - Rio Tinto (Estação)',          color: '#187EC2', text_color: '#FFFFFF' },
  { id: '400',  number: '400', name: 'Batalha - Paranhos',                     color: '#187EC2', text_color: '#FFFFFF' },
  { id: '401',  number: '401', name: 'Batalha - Paranhos (circular)',          color: '#187EC2', text_color: '#FFFFFF' },
  { id: '402',  number: '402', name: 'Trindade - Paranhos',                    color: '#187EC2', text_color: '#FFFFFF' },
  { id: '403',  number: '403', name: 'Trindade - S. Roque da Lameira',        color: '#187EC2', text_color: '#FFFFFF' },
  { id: '404',  number: '404', name: 'Maternidade - Nau Vitória',             color: '#187EC2', text_color: '#FFFFFF' },
  { id: '500',  number: '500', name: 'Praça Liberdade - Matosinhos (Mercado)', color: '#FCD116', text_color: '#000000' },
  { id: '501',  number: '501', name: 'Cordoaria - Castelo do Queijo',         color: '#FCD116', text_color: '#000000' },
  { id: '502',  number: '502', name: 'Cordoaria - Foz (via Boavista)',         color: '#FCD116', text_color: '#000000' },
  { id: '503',  number: '503', name: 'Cordoaria - Nevogilde',                  color: '#FCD116', text_color: '#000000' },
  { id: '504',  number: '504', name: 'Cordoaria - Matosinhos (via Foz)',      color: '#FCD116', text_color: '#000000' },
  { id: '505',  number: '505', name: 'Bolhão - Foz',                           color: '#FCD116', text_color: '#000000' },
  { id: '506',  number: '506', name: 'Trindade - S. João de Deus',            color: '#FCD116', text_color: '#000000' },
  { id: '507',  number: '507', name: 'Trindade - Francos',                     color: '#FCD116', text_color: '#000000' },
  { id: '508',  number: '508', name: 'Trindade - Aldoar',                      color: '#FCD116', text_color: '#000000' },
  { id: '600',  number: '600', name: 'São Bento - Pedrouços',                  color: '#F5A623', text_color: '#ffffff' },
  { id: '601',  number: '601', name: 'Campanhã - Pedrouços',                   color: '#F5A623', text_color: '#ffffff' },
  { id: '602',  number: '602', name: 'Campanhã - Aeroporto',                   color: '#F5A623', text_color: '#ffffff' },
  ...
  { id: '903',  number: '903', name: 'Trindade - Campanhã (circular)',        color: '#2E86AB', text_color: '#FFFFFF' },
    { id: '1M',   number: '1M',  name: 'Aliados - Matosinhos',                   color: '#000000', text_color: '#FFFFFF' },
];
